...
package ru.themes.Collection.Map;

import java.util.*;

/**
 * Задание:
 * описать разницу между HashMap и IdentityHashMap. Для чего нужна IdentityHashMap?
 *
 * Ответ:
 * IdentityHashMap - это структура данных, так же реализующая интерфейс Map и использующая при сравнении
 * ключей (значений) сравнение ссылок, а не вызов метода equals(). Другими словами, в IdentityHashMap два ключа k1 и k2
 ...
 * по этой причине IdentityHashMap по сравнению с HashMap имеет более высокую производительность, особенно если последний
 * хранит объекты с дорогостоящими методами equals() и hashCode().
 *
 ...
 * программе необходимо обслуживать хэш-таблицу со всеми ссылками на объекты, которые уже были обработаны.
...
public class HashMapAndIdentityHashMap {
	public static void main(String[] args) {
		HashMapAndIdentityHashMap q = new HashMapAndIdentityHashMap();
